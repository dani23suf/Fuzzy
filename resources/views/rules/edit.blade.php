            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form" action="{{ route('update-rules') }}" method="POST" data-parsley-validate>
                                @csrf
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="umur" class="form-control" id="umur" required>
                                                ...
                                                <option value="{{ $item }} " {{ $item == $rule->umur ? 'selected' : '' }}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                        @error('umur')
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="berat_badan" class="form-control"  id="berat_badan" required>
                                                ...
                                                <option value="{{ $item }}" {{ $item == $rule->berat_badan ? 'selected' : '' }}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                        @error('berat_badan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="tinggi_badan" class="form-control"  id="tinggi_badan" required>
                                                ...
                                                <option value="{{ $item }}" {{ $item == $rule->tinggi_badan ? 'selected' : '' }}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                        @error('tinggi_badan')
                                            <div class="alert alert-danger">{{ $message }}</div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="lingkar_lengan" class="form-control"  id="lingkar_lengan" required>
                                                <option value="" disabled >Pilih Lingkar Lengan</option>
                                                @foreach($lingkarLengan as $item)
                                                <option value="{{ $item }} " {{ $item == $rule->lingkar_lengan ? 'selected' : '' }}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="status_gizi" class="form-control"  id="status_gizi" required>
                                                <option value="" disabled   >Pilih Status Gizi</option>
                                                @foreach($statusGizi as $item)
                                                <option value="{{ $item }} " {{ $item == $rule->status_gizi ? 'selected' : '' }}>{{ $item }}</option>
                                                @endforeach
                                            </select>
                                        @error('status_gizi')
                                            <div class="alert alert-danger">{{ $message }}</div>
