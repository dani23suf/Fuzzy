                    ...
                    <table class="table" id="table1">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Nilai Z</th>
                        ...
                        <tbody>
                            @foreach ($hasil as $item)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->balita->nama}}</td>
                                    <td class="text-center">{{ $item->balita->jenis_kelamin}}</td>
                                    ...
                                    <td class="d-flex justify-content-around align-items-center" style="height: 199.117px">
                                        ...
                                        <dl class="dt ma0 pa0 text-center">
                                            <dt class="the-icon">
                                                <form method="POST" action="{{ route('destroy-hasil',['id' => $item->id]) }}">
                                                    @csrf
                                                    @method('delete')
